...
class PublicAdminSite(admin.AdminSite):
    ...
    def has_permission(self, request):
        return request.user.is_active and request.user.is_staff and request.user.is_superuser and request.tenant.schema_name == 'public'
...
# 2. For managing specific tenant data
class TenantAdminSite(admin.AdminSite):
    ...
    def has_permission(self, request):
        ...
        # Глобальный суперюзер платформы может заходить везде
